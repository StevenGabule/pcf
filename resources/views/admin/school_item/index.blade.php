    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">School Items Management</h1>
            </div>

            <div class="card">
                <div class="card-body">
                    <h6>Table Lists</h6>
                    <table class="table table-sm small" id="school-items-table">
                        <thead>
                        <tr>
                            <th style="width:3%">#</th>
                            <th>Name</th>
...
@push('scripts')
    ...
    <script src="{{ secure_asset('template/js/admin/school_item.js') }}"></script>
@endpush
